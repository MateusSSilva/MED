...
#
# Output
#   output/adult/output_adult_R.csv — one row per trial, columns: file, ind,
...
files <- list.files(path = data_dir, pattern = "pos\\.csv$",
...
write.csv(output_MED, file.path(output_dir, "output_adult_R.csv"), row.names = FALSE)
